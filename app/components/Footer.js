      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start gap-6 text-2xl">
            <a href="https://github.com/ShahanwazSaddam144/Butt-Networks" target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 transition">
              <FaGithub />
            </a>
            <a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 transition">
              <FaLinkedin />
            </a>
          </div>
        </div>
