      ...
      >
        {services.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="Services-Container flex flex-col items-center justify-center cursor-pointer rounded-[10px] bg-gray-50 w-75 h-47.5 mx-auto p-4 shadow-md hover:shadow-lg transition-all duration-300 gap-3">
